...
%% KNN Classifier Training
    ...
    for dirn = 1:ndire
        ...
        spikes = cat(1, spikes, spike_count); % Compile spike count datareaching_angle = repmat(dirn, ntrial, 1)
        reaching_angle(1:ntrial) = dirn; % Label data with direction
        reach_angle = [reach_angle, reaching_angle]; 
